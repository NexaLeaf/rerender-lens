...
- Custom hook names are deliberately not attempted: they require re-running the component with a stub dispatcher (react-debug-tools), which a commit hook must not do.
